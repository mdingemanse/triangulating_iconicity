...
ggplot(d,aes(x=rating_z,y=logodds)) + geom_point(colour="dark grey",position="jitter") + geom_smooth(method=lm,colour="black")
ggsave("figures\\TI_03_corr.png",height=5,width=7.5)

ggplot(d,aes(x=rating_z,y=logodds)) + geom_point(aes(color=category,shape=language),position="jitter")
